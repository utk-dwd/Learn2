# 06 String Methods
course_name_python = "  python programming    "
...
# String method to convert to capitalise first letter of each word
...
print("utk" in course_name_python)
...
print("utk" not in course_name_python)
